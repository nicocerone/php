...
<a class="navbar-brand" href="index.php"><img src = "imagenes/restaurant.png" width="60" height="60" /></a>
        ...
        <div class="row justify-content-center">
            <div class="col-sm-5">
                <div class="card mt-5 mb-2">
                    <div class="card-header bg-dark font-weight-bold" style="color:#D80F0F;font-size: 30px;font-weight: bold">Iniciar Sesion</div>
                    <div class="card-body" style="background-color: #535353">
                        <form style="margin-left:2%;margin-right:2%" method="post" name="formularioInicioSesion" action="validacionInicioSesion.php" name="registro" onsubmit="return funcionJS()">
                            <h5 style="color:#000000;font-size: 20px;font-weight: bold"> Usuario</h5><input type="text" class="form-control" name="usuario">
                            <?php
                            ...
                            ?>
                            <br>
                            <h5 style="color:#000000;font-size: 20px;font-weight: bold"> Clave</h5><input type="password" class="form-control" name="clave">
                            <?php
                            ...
                            ?>
                            <br>
                            <button type="submit" name="submit" class="btn btn-danger" style="background-color:#D80F0F">Confirmar</button>
<br><br>
                        </form>
                    </div>
                </div>
